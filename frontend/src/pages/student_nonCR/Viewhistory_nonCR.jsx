...
const ViewHistory = () => {
  ...
  const fetchHistoryData = async (userId) => {
    try {
      ...
      setHistoryData(getDataArray(response));
      setError(null);
    } catch (error) {
  ...
  const currentData = filterData(historyData);
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800">Bicycle Borrowing History</h1>
            <p className="text-gray-600 mt-2">
              Track all your bicycle borrowing activities in one place
            </p>
          </div>
            ...
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-gray-500 mt-1">
                  {statusFilter === "all"
                    ? "You don't have any bicycle history yet."
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            {(entry.conditionDescription || entry.experienceRating) && (
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
