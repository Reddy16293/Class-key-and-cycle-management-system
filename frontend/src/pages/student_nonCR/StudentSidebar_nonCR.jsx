...
const StudentSidebar_nonCR = ({ sidebarOpen, setSidebarOpen, user }) => {
  const navigate = useNavigate();
  const location = useLocation();

  const navItems = [
    { path: "/dashboard/student_nonCR", icon: <FaHome />, label: "Dashboard" },
    { path: "/borrowbicycle_nonCR", icon: <FaBicycle />, label: "Borrow Bicycles" },
    { path: "/viewhistory_nonCR", icon: <FaHistory />, label: "View History" },
    { path: "/s-about_nonCR", icon: <FaInfoCircle />, label: "About" },
  ];
...
export default StudentSidebar_nonCR;